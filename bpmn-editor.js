    ...
    var bpmnEditor = (function (SVG, $, vkbeautify) {
        var constants = {
            sizes: {
                ...
                dataobj_width: 50,
                dataobj_height: 65,
                dataobj_line_len: 125,

                database_width: 50,
                database_height: 65,
                database_line_len: 125,

                smartobject_width: 50,
                smartobject_height: 65,
                smartobject_line_len: 125,

                inputevent_width: 50,
                inputevent_height: 65,
                inputevent_line_len: 125,

                outputevent_width: 50,
                outputevent_height: 65,
                outputevent_line_len: 125,

                physicalentity_width: 60,
                physicalentity_height: 78,
                physicalentity_line_len: 125,
            },
            labelpathstring: {},
            attrs: {
                act: {
            ...
            },//end of context menu when right clicking

            //editlabel for the widgets, links, pool and swimlanes
            ...
            editlabel = {
                widget: {
                    ...
                    handler: function (event) {
                        ...
                        editlabel.show(pos, text, function (text) {
                            ...
                            if (text != "") {
                              // widget.elem.text(text).font({
                              //     family: 'Calibri',
                              //     size: 15
                              // }).path(path).attr("class", "item-label");
                                widget.data.text = widget.elem.text(text).path(path);
                            }
                        });
                    }
                },
                    ...
                    handler: function (event) {
                        ...
                        editlabel.show(pos, text, function (text) {
                            ...
                            if (text != "") {
                                ...
                                lnk.data.text.textPath.attr('startOffset', 40);
                            }
                        });
                    }
                },
                ...
                },//end of edit label for pool section
            ...
            //Adding info to the widgets: activities, events, gateway, link and data
            widgetsInfo = [
              //activities
                { type: "activity", id: 1, name: "process", src: "bpmn pic/ActivityHigh.png" },
                { type: "activity", id: 2, name: "userTask", src: "bpmn pic/user-task.png" },
                { type: "activity", id: 3, name: "service", src: "bpmn pic/service-task.png" },
                { type: "activity", id: 4, name: "business", src: "bpmn pic/business-rule.png" },
                { type: "activity", id: 5, name: "manualTask", src: "bpmn pic/manual-task.png" },
                { type: "activity", id: 6, name: "subProcess", src: "bpmn pic/subprocess.png" },
	              { type: "activity", id: 7, name: "sensor", src: "bpmn pic/sensor_task1.png" },
                { type: "activity", id: 8, name: "actuator", src: "bpmn pic/actuator_task.png" },
                { type: "activity", id: 9, name: "reader", src: "bpmn pic/read_task.png" },
                { type: "activity", id: 10, name: "collector", src: "bpmn pic/collector_task.png" },
                { type: "activity", id: 11, name: "intermediary", src: "bpmn pic/interm_task.png" },
                { type: "activity", id: 12, name: "eventstreams", src: "bpmn pic/events_task.png" },
                //Events
                { type: "event", id: 1, name: "StartIntermediate", src: "bpmn pic/event (1).png" },
                ...
                //Data
                { type: "data", id: 1, name: "SmartObject", src: "bpmn pic/smartobject6.png" },
                { type: "data", id: 2, name: "InputEvent", src: "bpmn pic/inputevent.png" },
                { type: "data", id: 3, name: "OutputEvent", src: "bpmn pic/outputevent.png" },
                { type: "data", id: 4, name: "PhysicalEntity", src: "bpmn pic/physicalentity.png" },
                { type: "data", id: 5, name: "Annotation", src: "bpmn pic/annotation.png" },
                { type: "data", id: 6, name: "Group", src: "bpmn pic/group.png" },
                { type: "data", id: 7, name: "DataObject", src: "bpmn pic/data object.png" },
                { type: "data", id: 8, name: "Database", src: "bpmn pic/database.png" },
                { type: "data", id: 9, name: "DataInput", src: "bpmn pic/data-input.png" },
                { type: "data", id: 10, name: "DataOutput", src: "bpmn pic/data-output.png" }
            ];
      ...
      function exportXPDL() {
        ...
        function eventManager(item, eventname, handler, en) {
            ...
            */
            ...
            if (typeof elem !== 'undefined' && en) {
                elem.on(eventname, handler);
            }
            else if (typeof elem !== 'undefined' && !en)
            {
                elem.off(eventname, handler);
            }
        }
        ...
        //delete widget from context menu
        ...
        function initWidget(widget) {
            switch (widget.wid_type) {
                ...
                case "activity":
                    widget.elem.image(widget.data.src, constants.sizes.act_width, constants.sizes.act_height);
        ...
        return {
                            ...
                            $("<div></div>")
                                ...
                                .droppable({
                                    ...
                                    drop: function (event, ui) {
                                        ...
                                        var data = {
                                            src: ui.draggable.attr("src"),
                                            //src: ui.draggable.attr("data-widget-id"),
                ...
                widgets.forEach(function (widget) {
                    ...
                    switch (widget.wid_type) {
                            ...
                            if (numIn == numOut) {
                                ...
                                activities
                                    += '<Activity Id="' + widget.data.id + '" Name="' + (widget.data.text ? widget.data.text.content.trim() : "") + '">'
                                   	...
                                   	+ '<RouteAct ActivityType="' + widget.data.name + '"/>'
                        ...
                        case "data":
                            ...
                            if (numIn == numOut) {
                                if (numIn > 1) {
                                    error.messages.push("invalid data found");
                                    break;
                                }
                                activities
                                    += '<Activity Id="' + widget.data.id + '" Name="' + (widget.data.text ? widget.data.text.content.trim() : "") + '">'

                                    + '<RouteData DataType="' + widget.data.name + '"/>'
                                    ...
                                    + '</Performers>'
                                    + '<NodeGraphicsInfos>'
                                    + '<NodeGraphicsInfo BorderColor="0,0,0" FillColor="255,255,255" Height="' + constants.sizes.database_height + '" Width="' + constants.sizes.database_width + '" LaneId="' + widget.data.swimlane.data.id + '">'
                                    + '<Coordinates XCoordinate="' + widget.elem.x() + '" YCoordinate="' + widget.elem.y() + '"/>'
                                    + '</NodeGraphicsInfo>'
                                    + '</NodeGraphicsInfos>'
                                    + '</Activity>';
                        ...
                        case "gateway":
                            ...
                            if (numIn == numOut) {
                                error.messages.push("invalid gateway found");
                            }
            ...
            importXPDL: function (str) {
                ...
                root.find("Activities Activity").each(function () {
                    ...
                    } else if ($(this).find("RouteData").length) {
                        var dataName = $(this).find("RouteData").attr("DataType"),
                            info = getWidgetInfo("data", dataName);
                        data.src = info.src;
                        addWidget(x, y, parentSwl, "data", info.id, data);
                    ...
                    } else if ($(this).find("RouteAct").length) {
                        var actName = $(this).find("RouteAct").attr("ActivityType"),
                            info = getWidgetInfo("activity", actName);
                        data.src = info.src;
            ...
            if (bpmnEditor.poolselected()) {
                ...
                $("<div></div>")
                        ...
                        .append($("<div></div>")
                                    ...
                                    .text("This action cause every Data to be lost, Continue?"))
                        .append($("<div></div>")
